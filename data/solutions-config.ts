...
export const pricing: Record<SolutionSlug, PricingModel> = {
  "ai-chatbot": { kind: "hybrid", setup: { A: 299, B: 199 }, monthly: { A: 79, B: 49 } },
  "booking-system": { kind: "monthly-flat", monthly: { A: 49, B: 29 }, trustLine: "No commission, ever, unlike most booking platforms" },
  "review-system": { kind: "monthly-flat", monthly: { A: 39, B: 29 } },
  "speed-optimization": { kind: "one-time", oneTime: { A: [399, 399], B: [199, 199] } },
  "website-rebuild": { kind: "one-time", oneTime: { A: [1799, 3499], B: [1199, 2499] } },
};
...
export const solutionContent: Record<string, SolutionIndustryContent> = {
  "ai-chatbot:medico": {
    ...
    faqs: [
      { question: "How much does it cost?", answer: "$299 one-time to build and set up your practice's AI receptionist, then $79 a month to keep it running. No long-term contract, cancel anytime." },
...
RULES: Only use the facts given above. Never invent a price, a dentist's name, a policy, or medical advice that isn't listed here. If asked something outside this list, say a member of the team will follow up personally rather than guessing. Keep replies to 2-3 sentences.`,
  ...
  "ai-chatbot:trades": {
    ...
    faqs: [
      ...
      { question: "What does it cost?", answer: "$299 one-time setup, then $79 a month. It typically pays for itself with one extra job, and there's no long-term contract." },
    ],
...
RULES: Only use the facts given above. Never invent a menu item, price, or allergen claim that isn't listed here. For anything about severe allergies, tell the customer to confirm with the kitchen directly rather than answering yourself. Keep replies to 2-3 sentences.`,
  ...
  "booking-system:medico": {
    ...
    faqs: [
      ...
      { question: "How much does it cost?", answer: "$49 a month, no setup fee. No long-term contract, cancel anytime." },
    ],
...
RULES: Only use the facts given above. Never invent a price, dentist name, or medical advice not listed here. Keep replies to 2-3 sentences.`,
  ...
  "speed-optimization:medico": {
    ...
    faqs: [
      ...
      { question: "How much does it cost?", answer: "$399, one-time, scoped to your business on a free call." },
    ],
  ...
  "ai-chatbot:automotive": {
    ...
    features: [
      ...
      { icon: "calendar", title: "Drop-Off Scheduling", description: "Customers book a drop-off slot directly, synced with your bay availability" },
      { icon: "star", title: "Review Collection", description: "Automatic review requests after every completed repair" },
    ],
    roiDefaults: { missedPerWeek: 6, avgValue: 220, label: "per repair" },
    faqs: [
      { question: "I'm not tech-savvy, is this complicated?", answer: "No. Everything is set up for you, and job notifications land on your phone just like a text message." },
      { question: "What if it's an urgent repair, like a car that won't start?", answer: "Urgent requests are flagged immediately and sent to you by text and email. You decide whether to fit them in." },
      { question: "Can customers describe the problem before booking?", answer: "Yes. The AI asks what's wrong and can take a photo, which helps you assess the job before they arrive." },
      { question: "Does it work for a multi-bay shop?", answer: "Yes. It adapts to however many technicians and bays you're scheduling across." },
      { question: "What does it cost?", answer: "$299 one-time setup, then $79 a month. It typically pays for itself with one extra job, and there's no long-term contract." },
    ],
    proofStat: "Automation pipeline",
    proofDescription: "built and shipped scraping and scheduling automation in production",
    chatSystemPrompt: "You are the AI assistant for Apex Auto. Handle repair questions, rough estimates, and drop-off bookings. Services: Diagnostic check ($40), full service (from $120), brake repair (from $90), tyre fitting (from $20 each). Keep responses concise (2-3 sentences max).",
  },
  ...
  "ai-chatbot:med-spa": {
    ...
    faqs: [
      ...
      { question: "How much does it cost?", answer: "$299 one-time to build and set up your clinic's AI receptionist, then $79 a month to keep it running. No long-term contract, cancel anytime." },
    ],
